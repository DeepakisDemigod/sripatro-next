    ...
    <>
      ...
      <div className="py-8 min-h-screen bg-base-200 flex flex-col items-center">
          ...
          <div className="flex flex-col md:flex-row md:gap-8 gap-2">
            <div className="flex-1">
              <div className="mb-1 text-base-content/80">
                ...
                <span className="inline flex items-center gap-1 font-medium rounded-xs bg-green-600 p-1 text-md text-white">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
                    height="20"
        ...
        <div className="w-full max-w-2xl mt-4">
          <a
            href={`/bookings/${booking._id}/chat`}
            className="btn btn-error w-full text-white text-lg rounded-xl shadow-md"
            target="_blank"
